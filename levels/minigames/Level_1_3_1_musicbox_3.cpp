...
#include "L1_3_MusicBox3_MGScreen.h"
...
//-----------------------------------------------------------------------------------------------------
Level_1_3_1_musicbox_3::Level_1_3_1_musicbox_3() :
defeatAction( nullptr ),
winAction( nullptr )
{
    level = level_id::MG_1_3_1_MUSICBOX_3;
    
    this->levelGameWorldPath = new char[50];
    sprintf(levelGameWorldPath, "%s%s", PHYS_LANDSCAPES_PATH, "landscape1_3_1_musicbox_3.xml");
    this->levelGameObjectsPath = new char[50];
    sprintf(levelGameObjectsPath, "%s%s", PHYS_OBJECTS_PATH, "objects1_3_1_musicbox_3.xml");
}
...
//-----------------------------------------------------------------------------------------------------
Level_1_3_1_musicbox_3* Level_1_3_1_musicbox_3::create()
{
    Level_1_3_1_musicbox_3* pLevel_1_3_1_musicbox_3 = new Level_1_3_1_musicbox_3();
    if(pLevel_1_3_1_musicbox_3)
    {
        return pLevel_1_3_1_musicbox_3;
    }
    else
    {
        delete pLevel_1_3_1_musicbox_3;
        return NULL;
    }
}

//-----------------------------------------------------------------------------------------------------
bool Level_1_3_1_musicbox_3::init()
{
    //set using screens
    ...
    MANAGER_Screen->addScreen(GET_RUNNING_SCENE, screen_id::MG_L1_3_MUSICBOX_3);
...
//-----------------------------------------------------------------------------------------------------
void Level_1_3_1_musicbox_3::onEnter()
{
    ...
    if( this->getLevelState( "atfirst_musicbox_3_level_1_3_1" ) != 1 )
    {
        //complete stat
        MANAGER_Memory->getTempData()->statSecretPlaces += 1;
        this->setLevelState( "atfirst_musicbox_3_level_1_3_1", 1 );
    }
...
//-----------------------------------------------------------------------------------------------------
void Level_1_3_1_musicbox_3::onExit()
{
...
//-----------------------------------------------------------------------------------------------------
void Level_1_3_1_musicbox_3::release()
{
...
//-----------------------------------------------------------------------------------------------------
void Level_1_3_1_musicbox_3::update(float _dt)
{
    //Game camera following the player
    //pGameCamera->setPosition(pPlayer->getGameObject()->getPosition());
    if(pGameWorld && pGameCamera)
    {
        if( this->getLevelState( "mbox_2_go_to_level_1_boss" ) == 1 )
        {
            this->setLevelState( "mbox_2_go_to_level_1_boss", 0 );
...
//-----------------------------------------------------------------------------------------------------
bool Level_1_3_1_musicbox_3::onGetCoin(GameObject* _coin, std::string _key, PhysTriggerCoinKind _kind)
{
...
//-----------------------------------------------------------------------------------------------------
void Level_1_3_1_musicbox_3::onPortal(GameObject *_portal)
{
    if(pGameWorld && pGameCamera)
    {
        if(_portal->getId() == 900)
        {
            ...
            if( pPlayer->getGameObject()->getLocation() == game_object_location::GROUND )
            {
                ...
                this->winAction = Sequence::create( DelayTime::create( 2.0f ),
                                                     CallFunc::create( CC_CALLBACK_0( Level_1_3_1_musicbox_3::onVictory, this ) ), nullptr );
...
//-----------------------------------------------------------------------------------------------------
void Level_1_3_1_musicbox_3::onMinigameEnd(bool _isWin, screen_id _screen)
{
    if( _isWin )
    {
        this->pHudScreen->showSticker();
        dynamic_cast< L1_3_MusicBox3_MGScreen* >( MANAGER_Screen->getScreen( GET_RUNNING_SCENE, _screen ) )->hideMinigameInterface();
    ...
    else
    {
        ...
        this->defeatAction = Sequence::create( DelayTime::create( 2.0f ),
                                                CallFunc::create( CC_CALLBACK_0( Level_1_3_1_musicbox_3::onDefeat, this ) ), nullptr );
        GET_RUNNING_SCENE->runAction( this->defeatAction );
    }
}

//-----------------------------------------------------------------------------------------------------
void Level_1_3_1_musicbox_3::onVictory()
{
    if( this->getLevelState( "SINGLE_MINIGAME" ) == 0 )
    {
        this->setLevelState( "mbox_2_go_to_level_1_boss", 1 );
        this->setLevelState( "musicbox_2_level_1_boss_complete", 1 );
...
//-----------------------------------------------------------------------------------------------------
void Level_1_3_1_musicbox_3::onDefeat()
{
    if( this->getLevelState( "SINGLE_MINIGAME" ) == 0 )
    {
        this->setLevelState( "mbox_2_go_to_level_1_boss", 1 );
        this->setLevelState( "musicbox_2_level_1_boss_complete", 2 );
        this->saveLevelStatData();
    }
    else
    {
...
//-----------------------------------------------------------------------------------------------------
void Level_1_3_1_musicbox_3::determinePlayerPosition()
{
...
//-----------------------------------------------------------------------------------------------------
void Level_1_3_1_musicbox_3::saveLevelStatData()
{
