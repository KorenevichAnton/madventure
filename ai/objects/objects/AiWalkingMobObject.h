...
#ifndef __MusicalAdventure__AiWalkingMobObject__
#define __MusicalAdventure__AiWalkingMobObject__
...
namespace ai
{
    ...
    class AiWalkingMobObject: public IAiObject
    {
    public:
        static AiWalkingMobObject*                  create( tinyxml2::XMLElement* _xmlAiObject );
        void                                        release();
...
//-----------------------------------------------------------------------------------------------------
#endif /* defined(__MusicalAdventure__AiWalkingMobObject__) */
